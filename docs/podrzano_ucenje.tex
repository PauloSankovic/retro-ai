...
\begin{figure}[H]
    \centering
    \frame{\includegraphics[width=8cm]{assets/rl_diagram.png}}
...
\begin{figure}[H]
    \centering
    \frame{\includegraphics[width=12cm]{assets/q-learning.png}}
...
\begin{figure}[H]
    \centering
    \frame{\includegraphics[height=9.5cm]{assets/dql-algorithm.png}}
